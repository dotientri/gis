    ...
    def create_users(self):
        ...
        for username, email, role_code, fullname in users:
            try:
                ...
                user, created = NguoiDung.objects.update_or_create(
                ...
                self.stdout.write(f'  ✓ {action} user: {username} (Pass: 123456)')
...
Với quản lý bền vững, Công viên Bình Khánh cam kết bảo vệ hệ sinh thái và mang lại giá trị giáo dục cao cho du khách.''',
    ...
    def add_park_images(self, park):
        images_pool = [
            ...
            "https://images.unsplash.com/photo-1519331379826-f947873e307d?w=800&q=80",
            "https://images.unsplash.com/photo-1585938389612-a552a28d6914?w=800&q=80",
            "https://images.unsplash.com/photo-1575995995938-7a6f2e5e7958?w=800&q=80",
            "https://images.unsplash.com/photo-1562664377-709f2c337eb2?w=800&q=80",
            "https://images.unsplash.com/photo-1596233064276-093322da7a00?w=800&q=80",
